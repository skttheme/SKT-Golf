...
<?php esc_html_e( 'Skip to content', 'skt-golf' ); ?>
</a>
<?php
    ...
    <div class="logo">
		...
		<?php wp_nav_menu( array('theme_location' => 'primary', 'container' => 'ul', 'menu_id' => 'primary', 'menu_class' => 'primary-menu menu' ) ); ?>
            ...
            <div class="header-cart">
            	<a class="cart-customlocation" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'skt-golf' ); ?>"> <img class="cart-customlocation" src="<?php echo esc_url(get_template_directory_uri());?>/images/cart-icon.png" /> <span class="custom-cart-count"><div id="mini-cart-count"></div></span> </a>  
            </div>   
            <?php } ?>
                ...
                <div class="header-phone-number">
                    <?php if (!empty($header_phonenumbertext)) { ?>
                        ...
                        <span><?php esc_html_e('Call Now','skt-golf');?></span>
