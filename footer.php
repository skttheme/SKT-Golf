...
<div class="container">
     <div class="copyright-txt">
		...
		<?php } ?>
        <?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','skt-golf');?>        
        <a href="<?php echo esc_url('https://www.sktthemes.org/shop/free-golf-club-wordpress-theme');?>" target="_blank">
        <?php esc_html_e('SKT Golf','skt-golf'); ?>
        </a>
        </div>
     <div class="clear"></div>
</div>           
